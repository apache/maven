...
A plugin is described in a [`META-INF/maven/plugin.xml` plugin descriptor](./plugin.html), generally generated from plugin sources using [maven-plugin-plugin](/plugin-tools/maven-plugin-plugin/).
