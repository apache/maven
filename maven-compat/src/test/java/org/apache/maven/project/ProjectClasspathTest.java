...
public class ProjectClasspathTest extends AbstractMavenProjectTestCase {
    ...
    public void setUp() throws Exception {
        ArtifactResolver resolver = container.lookup(ArtifactResolver.class, "classpath");
        DefaultArtifactDescriptorReader pomReader =
                (DefaultArtifactDescriptorReader) container.lookup(ArtifactDescriptorReader.class);
