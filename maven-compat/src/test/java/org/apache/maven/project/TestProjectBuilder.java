...
{
    @Inject
    public TestProjectBuilder( ModelBuilder modelBuilder, ModelProcessor modelProcessor,
    ...
    {
        super( modelBuilder, modelProcessor, projectBuildingHelper, repositorySystem, repoSystem, repositoryManager,
               dependencyResolver, modelCacheFactory );
    }
