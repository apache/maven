...
/**
 * Resolves conflicts in the supplied dependency graph. Different implementations will implement different conflict
 * resolution policies.
 *
...
public interface GraphConflictResolver
{
    ...
    /**
     * Cleanses the supplied graph by leaving only one directed versioned edge\ between any two nodes, if multiple
     * exists. Uses scope relationships, defined in <code>ArtifactScopeEnum</code>
     *
