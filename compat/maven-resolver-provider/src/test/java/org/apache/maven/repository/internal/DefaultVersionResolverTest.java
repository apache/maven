...
class DefaultVersionResolverTest extends AbstractRepositoryTestCase {
    ...
    @Test
    void testSnapshotVersionFromMetadataWithInvalidTokenIsRejected() throws Exception {
    ...
    @Test
    void testSnapshotTimestampFromMetadataWithInvalidTokenIsRejected() throws Exception {
        VersionRequest request = new VersionRequest();
        request.addRepository(newTestRepository());
