...
| 8. | `maven.project.extensions` | `String` | Maven project-wide extensions. |  `${session.rootDirectory}/.mvn/extensions.xml`  |  | User properties |
| 9. | `maven.projectBuilder.parallelism` | `Integer` | ProjectBuilder parallelism. |  `cores/2 + 1`  |  | User properties |
