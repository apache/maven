...
public class ReactorGraph {
    ...
    public static void main(String[] args) {
        try {
            // Parse DOT file generated by org.fusesource.mvnplugins:maven-graph-plugin:reactor
            ...
            clusteredGraph.nodeAttrs().add("fontname", "Arial");
            ...
            System.out.println("High-level graph rendered to maven-deps.svg");
    ...
    private static MutableGraph generateHighLevelGraph(MutableGraph clusteredGraph, Map<String, MutableGraph> clusters,
        ...
        highLevelGraph.nodeAttrs().add("fontname", "Arial");
