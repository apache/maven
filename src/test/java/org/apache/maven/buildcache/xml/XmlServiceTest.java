...
public class XmlServiceTest
{
    ...
    public void testConfig() throws Exception
    {
        ...
        Document doc = db.parse( getClass().getResource( "build-cache-config-instance.xml" ).toString() );
    ...
    public void testReport() throws Exception
    {
        ...
        dbf.setSchema( schema );
        DocumentBuilder db = dbf.newDocumentBuilder();
        Document doc = db.parse( getClass().getResource( "build-cache-report-instance.xml" ).toString() );
    ...
    public void testBuild() throws Exception
    {
        ...
        dbf.setSchema( schema );
        DocumentBuilder db = dbf.newDocumentBuilder();
        Document doc = db.parse( getClass().getResource( "build-cache-build-instance.xml" ).toString() );
    ...
    public void testDiff() throws Exception
    {
        ...
        dbf.setSchema( schema );
        DocumentBuilder db = dbf.newDocumentBuilder();
        Document doc = db.parse( getClass().getResource( "build-cache-diff-instance.xml" ).toString() );
