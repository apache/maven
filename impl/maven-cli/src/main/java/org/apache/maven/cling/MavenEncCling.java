...
public class MavenEncCling extends ClingSupport {
    ...
    public static int main(
            ...
            throws IOException {
        return new MavenEncCling(world).run(args, in, out, err);
    }
    ...
    @Override
    protected ParserRequest.Builder parserRequestBuilder(String[] args) {
        return ParserRequest.mvnenc(args, new ProtoLogger(), new JLineMessageBuilderFactory());
    }
}
