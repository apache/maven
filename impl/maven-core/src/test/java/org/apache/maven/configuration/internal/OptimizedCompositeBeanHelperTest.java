...
/**
 * Test for OptimizedCompositeBeanHelper to ensure it works correctly and provides performance benefits.
 */
class OptimizedCompositeBeanHelperTest {

    private OptimizedCompositeBeanHelper helper;
    ...
    void setUp() {
        ...
        helper = new OptimizedCompositeBeanHelper(converterLookup, getClass().getClassLoader(), evaluator, listener);
    }
