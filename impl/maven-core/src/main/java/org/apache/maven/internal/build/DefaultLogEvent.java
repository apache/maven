 ...
 * @param projectId        the project this event belongs to, or {@code null}
 * @param mojoId           the mojo execution that produced this event, or {@code null}
 */
public record DefaultLogEvent(
    ...
    public DefaultLogEvent(
            ...
            String stackTrace,
            String formattedMessage) {
        this(timestamp, level, message, loggerName, stackTrace, formattedMessage, null, null, -1, -1, null, null);
    }
    ...
    DefaultLogEvent(Instant timestamp, LogLevel level, String message, String loggerName, String stackTrace) {
        this(timestamp, level, message, loggerName, stackTrace, null, null, null, -1, -1, null, null);
    }
}
