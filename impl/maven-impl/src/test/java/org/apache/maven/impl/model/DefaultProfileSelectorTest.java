...
public class DefaultProfileSelectorTest {
    ...
    void testNonCascadingActivation() {
        ...
        DefaultProfileActivationContext context =
                new DefaultProfileActivationContext(new DefaultRootLocator(), new DefaultInterpolator());
    ...
    private static class PropertyProfileActivator implements ProfileActivator {
        ...
        public boolean isActive(
            ...
            if (actualValue == null) {
                ...
                if (context instanceof DefaultProfileActivationContext dctx) {
                    actualValue = dctx.getModelPropertyForActivation(name);
                } else {
