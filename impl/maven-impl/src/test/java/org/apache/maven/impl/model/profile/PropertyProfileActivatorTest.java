...
class PropertyProfileActivatorTest extends AbstractProfileActivatorTest<PropertyProfileActivator> {
    ...
    @Test
    void testWithNameOnlyUserProperty() {
    ...
    @Test
    void testWithNameOnlySystemProperty() {
        Profile profile = newProfile("prop", null);
    ...
    @Test
    void testWithNegatedNameOnlyUserProperty() {
        Profile profile = newProfile("!prop", null);
    ...
    @Test
    void testWithValueUserProperty() {
    ...
    @Test
    void testWithValueSystemProperty() {
        Profile profile = newProfile("prop", "value");
    ...
    @Test
    void testWithNegatedValueUserProperty() {
        Profile profile = newProfile("prop", "!value");
    ...
    @Test
    void testWithNegatedValueSystemProperty() {
        Profile profile = newProfile("prop", "!value");
    ...
    @Test
    void testWithValueUserPropertyDominantOverSystemProperty() {
        Profile profile = newProfile("prop", "value");
