...
class TestIncrementalContext extends DefaultIncrementalContext {

    TestIncrementalContext(Path stateFile, Map<String, Serializable> configuration) {
        this(new FilesystemWorkspace(), stateFile, configuration);
    }

    TestIncrementalContext(Workspace workspace, Path stateFile, Map<String, Serializable> configuration) {
    ...
    protected DefaultIncrementalContextState getState(Path source) {
