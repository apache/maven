...
class TestBuildContext extends DefaultBuildContext {
    ...
    TestBuildContext(Path stateFile, Map<String, Serializable> configuration) {
        this(new FilesystemWorkspace(), stateFile, configuration);
    }

    TestBuildContext(Workspace workspace, Path stateFile, Map<String, Serializable> configuration) {
