...
public record DefaultSourceRoot(
    ...
    public DefaultSourceRoot(ProjectScope scope, Language language, Path directory) {
        this(scope, language, directory, false);
    }
     ...
     * @param generated whether the source files are generated by the build
     */
    public DefaultSourceRoot(ProjectScope scope, Language language, Path directory, boolean generated) {
        this(scope, language, null, null, directory, null, null, false, null, generated, true);
    }

    /**
     * Creates an instance while retaining the constructor signature used before generated-source metadata was added.
     */
    ...
    public DefaultSourceRoot(final Path baseDir, ProjectScope scope, Resource resource) {
        this(baseDir, scope, resource, false);
    }

    /**
     * Creates a new instance from the given resource while preserving generated-source metadata.
     *
     * @param baseDir the base directory for resolving relative paths (used only for the source directory)
     * @param scope the scope of the resource (main or test)
     * @param resource a resource element from the model
     * @param generated whether the source files are generated by the build
     */
    public DefaultSourceRoot(final Path baseDir, ProjectScope scope, Resource resource, boolean generated) {
        this(
                scope,
                Language.RESOURCES,
                null,
