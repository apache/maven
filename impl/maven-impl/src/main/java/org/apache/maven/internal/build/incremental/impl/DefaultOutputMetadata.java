...
public class DefaultOutputMetadata extends DefaultMetadata<Output> {
    public DefaultOutputMetadata(
            DefaultIncrementalContext context, DefaultIncrementalContextState state, Path resource) {
