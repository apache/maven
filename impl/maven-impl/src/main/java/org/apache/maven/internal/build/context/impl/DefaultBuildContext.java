...
public class DefaultBuildContext implements CommitableBuildContext {
    ...
    private Collection<Path> getOutputInputs(DefaultBuildContextState contextState, Path outputFile) {
    ...
    protected <T extends Serializable> T getResourceAttribute(
            DefaultBuildContextState contextState, Path resource, String key, Class<T> clazz) {
