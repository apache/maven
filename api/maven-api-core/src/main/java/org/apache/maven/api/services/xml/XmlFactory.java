    ...
    extends Service
{
    ...
    @Nonnull
    default T read( @Nonnull
    InputStream input, boolean strict )
        throws XmlReaderException
    {
     ...
     */
    default T fromXmlString( @Nonnull
    String xml )
        throws XmlReaderException
    {
     ...
     */
    default String toXmlString( @Nonnull
    T content )
        throws XmlWriterException
    {
