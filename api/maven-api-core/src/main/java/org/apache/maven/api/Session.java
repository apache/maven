...
public interface Session
{
    ...
    /**
     * Returns the plugin context for mojo being executed and the specified {@link Project}, never returns {@code null}
     * as if context not present, creates it. <strong>Implementation note:</strong> while this method return type is
     * {@link Map}, the returned map instance implements {@link java.util.concurrent.ConcurrentMap} as well.
     *
     * @throws org.apache.maven.api.services.MavenException if not called from the within a mojo execution
     */
    @Nonnull
    Map<String, Object> getPluginContext( @Nonnull
    Project project );
     ...
     */
    @Nonnull
    <T extends Service> T getService( @Nonnull
    Class<T> clazz );
     ...
     */
    @Nonnull
    Session withLocalRepository( @Nonnull
     ...
     */
    @Nonnull
    Session withRemoteRepositories( @Nonnull
     ...
     * @throws NullPointerException if {@code listener} is null
     */
    void unregisterListener( @Nonnull
    Listener listener );
     ...
     */
    @Nonnull
    RemoteRepository createRemoteRepository( @Nonnull
    String id, @Nonnull
    String url );
     ...
     * Shortcut for <code>getService(ArtifactFactory.class).create(...)</code>
     * 
     * @see org.apache.maven.api.services.ArtifactFactory#create(Session, String, String, String, String, String,
     *      String)
     */
     ...
     */
    @Nonnull
    DependencyCoordinate createDependencyCoordinate( @Nonnull
     ...
     *      String)
     */
    Artifact createArtifact( String groupId, String artifactId, String version, String classifier, String extension,
                             String type );
     ...
     */
    @Nonnull
    Optional<Path> getArtifactPath( @Nonnull
    Artifact artifact );
     ...
     */
    boolean isVersionSnapshot( @Nonnull
    String version );
     ...
     */
    @Nonnull
    Node collectDependencies( @Nonnull
    Artifact artifact );
    ...
    Path getPathForLocalArtifact( @Nonnull
    Artifact artifact );
     ...
     */
    @Nonnull
    VersionRange parseVersionRange( @Nonnull
    String versionRange );
}
