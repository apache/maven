...
public interface Project {
     ...
     * </p>
     * <ul>
     *   <li>If {@link ProjectScope#MAIN}, returns the directory where compiled application classes
     *       and main resources are placed (typically {@code target/classes}).</li>
     *   <li>If {@link ProjectScope#TEST}, returns the directory where compiled test classes
     *       and test resources are placed (typically {@code target/test-classes}).</li>
     *   <li>Otherwise (including {@code null}), returns the parent directory where all generated
     *       files are placed (typically {@code target}).</li>
     * </ul>
     * <p>
     * <strong>Usage in Path Resolution:</strong> This method is used by {@link SourceRoot#targetPath(Project)}
     * to resolve relative {@code targetPath} values. When a {@link SourceRoot} has a relative
     * {@code targetPath}, it is resolved against the output directory returned by this method
     * for the source root's scope.
     * </p>
     * <p>
     * <strong>Maven 3 Compatibility:</strong> This behavior maintains the Maven 3.x semantic
     * where resource {@code targetPath} elements are resolved relative to the appropriate
     * output directory, not the project base directory.
     * </p>
     *
