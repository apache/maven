...
{
    /**
     * Checks the specified file model for missing or invalid values. This model is directly created from the POM file
     * and has not been subjected to inheritance, interpolation or profile/default injection.
     *
