...
public class ProfileActivationFilePathInterpolator
{
     ...
     */
    public String interpolate( String path, ProfileActivationContext context )
        throws InterpolationException
    {
        ...
        if ( basedir != null )
        {
            interpolator.addValueSource( new AbstractValueSource( false )
            {
                ...
                {
                    /*
                     * We intentionally only support ${basedir} and not ${project.basedir} as the latter form would
                     * suggest that other project.* expressions can be used which is beyond the design.
                     */
