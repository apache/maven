...
public class MavenITmng1021EqualAttachmentBuildNumberTest extends AbstractMavenIntegrationTestCase {
    ...
    public void testitMNG1021() throws Exception {
        ...
        verifier.deleteArtifacts("org.apache.maven.its.mng1021", null);
        verifier.addCliArgument("-Dmaven.consumer.pom=false");
        verifier.addCliArgument("initialize");
        verifier.execute();
        verifier.verifyErrorFreeLog();

        verifier.verifyArtifactPresent("org.apache.maven.its.mng1021", "test", "1-SNAPSHOT", "pom", null);
        verifier.verifyArtifactPresent("org.apache.maven.its.mng1021", "test", "1-SNAPSHOT", "jar", null);
