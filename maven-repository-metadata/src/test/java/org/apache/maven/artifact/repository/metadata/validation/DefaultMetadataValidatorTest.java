...
class DefaultMetadataValidatorTest
{
    ...
    void testValidateArtifactMetadata()
    {
        ...
        assertContains( problems.messages.get( 0 ), "'groupId' is missing" );
        assertContains( problems.messages.get( 1 ), "'artifactId' is missing" );
    ...
    void testValidateGroupIdMetadata()
    {
        ...
        SimpleProblemCollector problems = new SimpleProblemCollector();
        validator.validate( metadata, true, problems );
        assertEquals( 0, problems.messages.size() );
        ...
        assertContains( problems.messages.get( 0 ), "'plugins.plugin.name' is missing" );
        assertContains( problems.messages.get( 1 ), "'plugins.plugin.prefix' is missing" );
        assertContains( problems.messages.get( 2 ), "'plugins.plugin.artifactId' is missing" );

        plugin.setArtifactId( "myOtherArtifactId" );
        problems = new SimpleProblemCollector();
        validator.validate( metadata, problems );
        assertEquals( 2, problems.messages.size() );
        assertContains( problems.messages.get( 0 ), "'plugins.plugin.name' for myOtherArtifactId is missing" );
        assertContains( problems.messages.get( 1 ), "'plugins.plugin.prefix' is missing" );
        ...
        validator.validate( metadata, problems );
        assertEquals( 1, problems.messages.size() );
        assertContains( problems.messages.get( 0 ), "'plugins.plugin.prefix' for myOtherPluginName is missing" );
    ...
    private static class SimpleProblemCollector
        implements MetadataProblemCollector
    {
