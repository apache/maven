...
public interface MavenOptions extends Options {
    ...
    /**
     * Returns new instance of {@link MavenOptions} that is result of interpolating this instance with given collection
     * of properties.
     */
    @Nonnull
    MavenOptions interpolate(Collection<Map<String, String>> properties);
}
