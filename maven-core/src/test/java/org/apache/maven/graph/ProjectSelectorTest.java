...
class ProjectSelectorTest
{
    ...
    @Test
    void isMatchingProjectMatchOnFileReturnsTrue()
        throws IOException
    {
    ...
    @Test
    void isMatchingProjectMatchOnDirectoryReturnsTrue( @TempDir
    File tempDir )
    {
    ...
    void getRequiredProjectsBySelectorsThrowsMavenExecutionException()
    {
        ...
        final MavenExecutionException exception =
            assertThrows( MavenExecutionException.class,
                          () -> sut.getRequiredProjectsBySelectors( mavenExecutionRequest, listOfProjects,
                                                                    selectors ) );
    ...
    @Test
    void getRequiredProjectsBySelectorsReturnsProject()
