...
public class PluginDescriptorRequirementsValidatorTest {
    ...
    @Test
    public void testValidateReportsIssueWhenMojoHasRequirements() {
        MojoDescriptor mojoDescriptor = new MojoDescriptor();
        mojoDescriptor.addRequirement(new ComponentRequirement());
    ...
    @Test
    public void testValidateDoesNotReportIssueWhenMojoHasNoRequirements() {
        MojoDescriptor mojoDescriptor = new MojoDescriptor();
