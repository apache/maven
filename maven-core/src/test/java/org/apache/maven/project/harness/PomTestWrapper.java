...
public class PomTestWrapper
{
    ...
    /*
     * public int containerCountForUri( String uri ) throws IOException { Validate.notEmpty( uri,
     * "uri can neither be null nor empty " ); ModelDataSource source = new DefaultModelDataSource(); source.init(
     * domainModel.getModelProperties(), null ); return source.queryFor( uri ).size(); }
     */
