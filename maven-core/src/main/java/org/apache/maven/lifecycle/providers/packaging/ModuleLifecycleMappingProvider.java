...
/**
 * JPMS {@code module} packaging plugins bindings provider for {@code default} lifecycle.
 */
@Named("module")
@Singleton
public final class ModuleLifecycleMappingProvider extends AbstractLifecycleMappingProvider {
    // START SNIPPET: jar
    ...
    @Inject
    public ModuleLifecycleMappingProvider() {
        super(BINDINGS);
    }
}
