    ...
    extends AbstractLifecycleMappingProvider
{
    ...
    private static final String[] BINDINGS = { "process-resources",
        ...
        "org.apache.maven.plugins:maven-compiler-plugin:" + COMPILER_PLUGIN_VERSION + ":compile", "process-classes",
        "org.apache.maven.plugins:maven-plugin-plugin:" + PLUGIN_PLUGIN_VERSION + ":descriptor",
        ...
        "install", "org.apache.maven.plugins:maven-install-plugin:" + INSTALL_PLUGIN_VERSION + ":install", "deploy",
