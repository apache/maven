...
public interface ToolchainManager
{
    ...
    /**
     * Retrieve toolchain of specified type from build context. It is expected that <code>maven-toolchains-plugin</code>
     * contains the configuration to select the appropriate toolchain and is executed at the beginning of the build.
     *
     ...
     * <code>maven-toolchains-plugin</code>.
     *
