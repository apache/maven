...
set ORIG_MAVEN_OPTS=%MAVEN_OPTS%
set MAVEN_OPTS=%ORIG_MAVEN_OPTS% -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=8000
...
set MAVEN_OPTS=%ORIG_MAVEN_OPTS%
exit /B %ERROR_CODE%
