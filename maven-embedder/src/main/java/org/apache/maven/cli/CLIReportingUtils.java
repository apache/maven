...
public final class CLIReportingUtils {
	...
	public static String showVersion() {
		...
		version.append("JRE used: ").append(System.getProperty("java.home", "<unknown Java home>")).append(ls);
	...
	/**
	 * Create a human readable string containing the Maven version, buildnumber,
	 * and time of build
	 *
