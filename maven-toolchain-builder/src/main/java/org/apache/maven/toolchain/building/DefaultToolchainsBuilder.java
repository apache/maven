    ...
    implements ToolchainsBuilder
{
        ...
        throws ToolchainsBuildingException
    {
        ...
        return new DefaultToolchainsBuildingResult( new org.apache.maven.toolchain.model.PersistedToolchains( merged ),
                                                ...
                                                ProblemCollector problems )
    {
        ...
        {
            problems.add( Problem.Severity.FATAL,
                          "Non-readable toolchains " + toolchainsSource.getLocation() + ": " + e.getMessage(), -1, -1,
                          e );
            return PersistedToolchains.newInstance();
        }
