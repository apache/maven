...
import org.apache.maven.internal.impl.model.DefaultTransformerContext.*;
...
public class BuildModelSourceTransformer implements ModelSourceTransformer {
    ...
    @Override
    public Model transform(Path pomFile, TransformerContext context, Model model) {
    ...
    //
    void handleParent(Path pomFile, TransformerContext context, Model model, Model.Builder builder) {
    ...
    //
    void handleCiFriendlyVersion(TransformerContext context, Model model, Model.Builder builder) {
    ...
    //
    void handleReactorDependencies(TransformerContext context, Model model, Model.Builder builder) {
